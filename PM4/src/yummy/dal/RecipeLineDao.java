...
public class RecipeLineDao {
    ...
    public RecipeLine create(RecipeLine recipeLine) throws SQLException {
        String insertForm = "INSERT INTO IngredientLine(id,amountNumerator,amountDenominator,unitOfMeasurement,foodId,recipeId,description) VALUES(?,?,?,?,?,?,?);";
    ...
    public RecipeLine getById(String id) throws SQLException {
        String selectForm = "SELECT id,amountNumerator,amountDenominator,unitOfMeasurement,foodId,recipeId,description FROM IngredientLine WHERE id=?;";
