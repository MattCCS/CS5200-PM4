...
<title>Show Allergens</title>
</head>
<body>
    <a href="index.jsp">Home</a>

    <h1>Show Allergens</h1>

    <form action=showAllergens method="get">
        <p>
        ...
        <table border="1">
            ...
            <c:forEach items="${results}" var="result" >
                <tr>
                    ...
                    <td><c:out value="${result.get(5)}" /></td>
                    <td><c:out value="${result.get(6)}" /></td>
                    <td><c:out value="${result.get(7)}" /></td>
